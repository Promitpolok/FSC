 ...
 * @author USER
 */
public class Digital_Marketing_ExcutiveController implements Initializable {
    ...
    @FXML
    private void adsButtonOnClick(ActionEvent event) throws IOException { 
                Parent root = null;
...
myStage.show();  
    ...
    @FXML
    private void surveyButtonOnClick(ActionEvent event) {
    }
